...
const databaseURL = "https://word-cloud-e47e5.firebaseio.com";
    ...
    render(){
        ...
        return(
            <div>
                ...
                <Fab color="primary" className={mergeClasses.fab} onClick={this.handleDialogToggle}>
                    <AddIcon />
                </Fab>
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        ...
                        <TextField label="가중치" type="text" name="weight" value={this.state.weightd} onChange={this.handleValueChange} /><br />
                    </DialogContent>
                    <DialogActions>
